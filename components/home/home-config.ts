...
export const HOME_CARDS: CardConfig[] = [
  {
    ...
    description: "Take a comprehensive quiz to gauge your current knowledge level",
    href: "/quiz",
    icon: Target,
    badge: {
      icon: BookOpen,
  ...
  {
    title: "Case Study",
    description: "Interactive clinical case with chat-based information gathering",
    href: "/case-study", 
    icon: MessageSquare,
    badge: {
      icon: Brain,
  ...
  },
  {
    ...
    description: "Study specific topics with detailed explanations and immediate feedback",
    href: "/categories",
    icon: Microscope,
    badge: {
      icon: BookOpen,
  ...
  {
    title: "Analytics",
    description: "Track your progress and identify areas for improvement and growth",
    href: "/analytics",
    icon: TrendingUp,
    badge: {
      icon: Target,
