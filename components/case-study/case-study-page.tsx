      ...
      <div className="max-w-7xl mx-auto h-full flex flex-col">
        ...
        <div className="grid grid-cols-2 gap-6 flex-1 min-h-0">
          ...
          <div className="flex flex-col gap-4 min-h-0">
            ...
            {/* Question and Answer */}
            <div className="bg-card border-2 border-border rounded-lg shadow-lg p-8 transition-all duration-150 flex-1 min-h-0 flex flex-col">
          ...
          {/* Chat Interface */}
          <div className="bg-card border-2 border-border rounded-lg shadow-lg p-8 transition-all duration-150 flex flex-col min-h-0">
