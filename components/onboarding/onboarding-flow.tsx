  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <motion.header
        ...
        className="fixed top-0 left-0 right-0 z-20 bg-background/80 backdrop-blur-sm"
      >
      ...
      <main className="h-screen w-full flex flex-col items-center justify-center p-4">
        <motion.div
          className="max-w-4xl w-full mx-auto bg-card rounded-lg shadow-lg p-8 border border-border"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
